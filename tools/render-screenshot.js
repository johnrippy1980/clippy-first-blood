...
if (stage === 8) level.loadStage8();
else if (stage === 7) level.loadStage7();
else if (stage === 6) level.loadStage6();
...
const themeMap = { 1: 'jungle', 2: 'breakroom', 3: 'serverroom', 4: 'boardroom', 5: 'keynote', 6: 'founder', 7: 'founder', 8: 'cloud' };
