...
export class Game {
    ...
    _drawStageCard() {
        ...
        const STAGE_CARDS = {
            ...
            8: 'card_keynote',
            9: 'card_keynote',          // R291: reuse keynote backdrop for corridor card
            10: 'card_gates_arena_2026',    // R400: dedicated stage-10 card
            11: 'card_founder_2026',        // R400: gothic founder's lair (was reusing stage-6 card)
            12: 'card_bossrush_2026',       // R400: painted door-gallery boss rush
            13: 'card_cloud_2026',          // R400: data-storm sky platform
            14: 'card_recyclebin_2026',     // R400: corrupted-files underworld
            ...
            // R423d+R424: stage 16 was BOSS RUSH (now relocated to slot 24).
            // Slot 16 now holds FLOOR 11 — Doom-style super-secret. Card
            // generated by R424; falls back to apocalypse card until painted.
            16: 'card_doom_floor11',
            17: 'card_recyclebin_2026', // Time Trial — same locked-in vibe
            18: 'card_reality_2026',    // R400: dedicated reality-distortion card (was reusing spindler-lab)
            ...
            // R423c+R424: stage 23 BLOCK 11 — Doom-style sewer crawl
            23: 'card_doom_block11',
            // R426: stage 24 BOSS RUSH MODE — painted door-gallery card
            // (reuses the existing painted bossrush card since the mode is
            // unchanged from when it was at slot 16)
